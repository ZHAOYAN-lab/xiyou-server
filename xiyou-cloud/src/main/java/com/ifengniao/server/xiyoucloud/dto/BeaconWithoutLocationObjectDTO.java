...
public class BeaconWithoutLocationObjectDTO {
    ...
    public BeaconWithoutLocationObjectDTO simplify() {
//        this.beaconId = null;
//        this.beaconMac = null;
//        this.beaconX = null;
//        this.beaconY = null;
...
//        this.beaconMapId = null;
        this.beaconZoneId = null;
        this.beaconZoneName = null;
        return this;
    }

    public static List<BeaconWithoutLocationObjectDTO> covert(Collection<BeaconEntity> list) {
        List<BeaconWithoutLocationObjectDTO> result = new ArrayList<>();
        if (list != null) {
            for (var source : list) {
                result.add(new BeaconWithoutLocationObjectDTO(source));
            }
        }
        return result;
    }

    public static List<BeaconWithoutLocationObjectDTO> covertSimplify(Collection<BeaconEntity> list) {
        List<BeaconWithoutLocationObjectDTO> result = new ArrayList<>();
        if (list != null) {
            for (var source : list) {
                result.add(new BeaconWithoutLocationObjectDTO(source).simplify());
            }
        }
        return result;
    }

    public static List<BeaconWithoutLocationObjectDTO> covertSimple(Collection<SimpleBeaconEntity> list) {
        List<BeaconWithoutLocationObjectDTO> result = new ArrayList<>();
        if (list != null) {
            for (var source : list) {
                result.add(new BeaconWithoutLocationObjectDTO(source));
    ...
    public BeaconWithoutLocationObjectDTO(BeaconEntity beaconEntity) {
    ...
    public BeaconWithoutLocationObjectDTO(SimpleBeaconEntity beaconEntity) {
        this.beaconId = beaconEntity.getBeaconId();
        this.beaconMac = beaconEntity.getBeaconMac();
        this.beaconX = beaconEntity.getBeaconX();
        this.beaconY = beaconEntity.getBeaconY();
